...
const Home = () => (
  <div className="home">
    ...
    <p>The SSL driver is down, hack the open-source circuit so we can generate the RAM program!</p>
    <img src="https://s3.amazonaws.com/uifaces/faces/twitter/darylws/128.jpg"></img>
  </div>
);
